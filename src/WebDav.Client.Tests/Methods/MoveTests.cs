...
namespace WebDav.Client.Tests.Methods
{
    public class MoveTests
    {
        ...
        [Fact]
        public async Task When_IsCalled_Should_SendMoveRequest()
        {
        ...
        [Fact]
        public async Task When_IsCalledWithDestLockToken_Should_SetIfHeader()
        {
            var sourceUri = new Uri("http://example.com/old");
            var dispatcher = Dispatcher.Mock();
            var client = new WebDavClient().SetWebDavDispatcher(dispatcher);
        ...
        [Fact]
        public async Task When_IsCalledWithSourceLockToken_Should_SetIfHeader()
        {
            var sourceUri = new Uri("http://example.com/old");
            var dispatcher = Dispatcher.Mock();
            var client = new WebDavClient().SetWebDavDispatcher(dispatcher);
        ...
        [Fact]
        public async Task When_IsCalledWithBothLockTokens_Should_SetIfHeaderWithBothTokens()
        {
            var sourceUri = new Uri("http://example.com/old");
            var dispatcher = Dispatcher.Mock();
            var client = new WebDavClient().SetWebDavDispatcher(dispatcher);
